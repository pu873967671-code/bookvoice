...
async function generateMockMp3(text: string, outPath: string) {
  ...
  // 使用预制的静音 MP3（避免依赖 ffmpeg）
  // 这是一个最小的静音 MP3 帧（约 0.1 秒），会被重复
  const silentFrameBase64 = '';
  
  const silentFrame = Buffer.from(silentFrameBase64, 'base64');
  // 根据需要的秒数重复帧（约 28 bytes 每帧，约 0.026 秒）
  const framesNeeded = Math.ceil(seconds / 0.026);
  const buffer = Buffer.alloc(silentFrame.length * framesNeeded);
  
  for (let i = 0; i < framesNeeded; i++) {
    silentFrame.copy(buffer, i * silentFrame.length);
  }
